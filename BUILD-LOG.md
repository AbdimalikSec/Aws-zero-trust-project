...
**What was built, how, and why every piece exists.** For the plain-language, analogy-driven walkthrough of how everything connects, read **[CONCEPTS.md](CONCEPTS.md)** first or alongside this — it's the companion piece, not a duplicate.
